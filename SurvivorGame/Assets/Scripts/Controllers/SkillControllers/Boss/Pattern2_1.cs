...
public class Pattern2_1 : SkillBase
{
    private void Start()
    {
        StartCoroutine("CoStartPattern2_2");
    }
    ...
    void Pattern2_2()
    {
        GameObject pattern2_2 = Managers.Resource.Instantiate("Skills/Boss/Pattern2_2");
